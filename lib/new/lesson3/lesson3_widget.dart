...
class Lesson3Widget extends StatefulWidget {
  const Lesson3Widget({
    super.key,
    required this.less,
  });

  final LessonsRecord? less;

  @override
  State<Lesson3Widget> createState() => _Lesson3WidgetState();
}

class _Lesson3WidgetState extends State<Lesson3Widget>
    with TickerProviderStateMixin {
  late Lesson3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Lesson3Model());
  }
    ...
    return StreamBuilder<List<LessonsRecord>>(
      stream: queryLessonsRecord(
        queryBuilder: (lessonsRecord) => lessonsRecord.where(
          'nameLessons',
          isEqualTo: widget.less?.nameLessons,
        ),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<LessonsRecord> lesson3LessonsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final lesson3LessonsRecord = lesson3LessonsRecordList.isNotEmpty
            ? lesson3LessonsRecordList.first
            : null;
              ...
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: GradientText(
                      lesson3LessonsRecord.ddddddddd,
