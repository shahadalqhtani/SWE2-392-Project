...
import 'correc4444_model.dart';
export 'correc4444_model.dart';

class Correc4444Widget extends StatefulWidget {
  const Correc4444Widget({
    super.key,
    required this.name,
  });
  ...
  @override
  State<Correc4444Widget> createState() => _Correc4444WidgetState();
}

class _Correc4444WidgetState extends State<Correc4444Widget> {
  late Correc4444Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Correc4444Model());
  }
